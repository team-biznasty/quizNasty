  ...
  return (
    <div className="aboutContainer">
      ...
      <ul>
        ...
        <br></br>
        <a href="https://github.com/jadavey91">jim</a>
        <br></br>
        <a href="https://github.com/mafromist">Muge</a>
        <br></br>
...
<br></br>
The quiz was constructed with the help of the opentrivia DB, which has saved us a massive amount of time due to not having to create a database for questions.</p>
    </div>
  );
}
